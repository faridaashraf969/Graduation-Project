...
//        const photographers = document.querySelectorAll('.photographer-card');
//        photographers.forEach(photographer => {
//            const specialty = photographer.getAttribute('data-specialty');
//            const location = photographer.getAttribute('data-location');
//            const price = photographer.getAttribute('data-price');
//            const availability = photographer.getAttribute('data-availability');
